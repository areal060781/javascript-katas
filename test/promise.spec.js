...
const { promiseResolve, promiseReject, fullPromise, promisesChaining, getAnimals } = require('../src/JS4SDET/promises');
const { asyncPromiseResolve, asyncPromiseReject, asyncPromiseAll } = require('../src/JS4SDET/asyncAwait');
